...
class AboutSets(Koan):
    ...
    def test_empty_sets_have_different_syntax_to_populated_sets(self):
        self.assertEqual({i for i in range(1, 4)}, {1, 2, 3})
        self.assertEqual({i for i in range(1, 1)}, set())
    ...
    def test_dictionaries_and_sets_use_same_curly_braces(self):
        ...
        self.assertEqual(dict, {}.__class__)  # NOTE: {} is default to be dict
    ...
    def test_we_can_compare_subsets(self):
        ...
        self.assertEqual(False, set('cake') > set('pie'))  # NOTE: '>' means has the subset and more
